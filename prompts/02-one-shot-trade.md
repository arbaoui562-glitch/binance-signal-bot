...
"Before we start — one quick thing. Talking to Claude is often faster than typing. There's
a tool called Wispr Flow — it turns your voice into text anywhere on your
...
"Which exchange are you going to use? BitGet is the default that this bot is built around
— if you want to use it, type 'bitget'. Otherwise pick from the list below:

1. BitGet *(default — bot is pre-configured for it)*
2. Binance
3. Bybit
4. OKX
5. Coinbase Advanced
...
- Windows: https://github.com/vaughanf1/claude-execute/blob/main/docs/setup-windows.md
- Linux: https://github.com/vaughanf1/claude-execute/blob/main/docs/setup-linux.md"
